    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-6">
        ...
        >
          ...
          The top demos advance to the season finale.
        </motion.p>
        ...
        >
          ...
          <Link
            href="/history"
            className="px-8 py-4 border-2 border-squid-gold text-squid-gold font-[family-name:var(--font-heading)] text-2xl tracking-wider rounded-xl hover:bg-squid-gold hover:text-squid-black transition-all"
          >
            VIEW HISTORY
          </Link>
